...
// MateableRPC is an interface to JSON-RPC bitcoind service.
type MateableRPC struct {
	*bchain.BaseChain
	client       http.Client
	rpcURL       string
	user         string
...
// NewMateableRPC returns new MateableRPC instance.
func NewMateableRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
	var err error
	var c Configuration
	...
	// btc supports both calls, other coins overriding MateableRPC can change this
...
// Initialize initializes MateableRPC instance.
func (b *MateableRPC) Initialize() error {
	...
	b.Parser = NewMateableParser(params, b.ChainConfig)
...
func (b *MateableRPC) CreateMempool(chain bchain.BlockChain) (bchain.Mempool, error) {
	if b.Mempool == nil {
...
func (b *MateableRPC) InitializeMempool(addrDescForOutpoint bchain.AddrDescForOutpointFunc, onNewTxAddr bchain.OnNewTxAddrFunc, onNewTx bchain.OnNewTxFunc) error {
	if b.Mempool == nil {
...
func (b *MateableRPC) Shutdown(ctx context.Context) error {
	if b.mq != nil {
...
func (b *MateableRPC) GetCoinName() string {
	return b.ChainConfig.CoinName
}

// GetSubversion returns the backend subversion
func (b *MateableRPC) GetSubversion() string {
...
type ResGetBlockChainInfo struct {
	...
	Result struct {
		...
		Bestblockhash string            `json:"bestblockhash"`
                Difficulty struct {
                       ProofOfWork  common.JSONNumber `json:"proof-of-work"`
                       ProofOfStake common.JSONNumber `json:"proof-of-stake"`
                }
...
func (b *MateableRPC) GetBestBlockHash() (string, error) {
...
func (b *MateableRPC) GetBestBlockHeight() (uint32, error) {
...
func (b *MateableRPC) GetChainInfo() (*bchain.ChainInfo, error) {
	...
	rv := &bchain.ChainInfo{
		...
		DifficultyPoW: string(resCi.Result.Difficulty.ProofOfWork),
                DifficultyPoS: string(resCi.Result.Difficulty.ProofOfStake),
...
func (b *MateableRPC) GetBlockHash(height uint32) (string, error) {
...
func (b *MateableRPC) GetBlockHeader(hash string) (*bchain.BlockHeader, error) {
...
func (b *MateableRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
	var err error
	if hash == "" {
...
func (b *MateableRPC) GetBlockInfo(hash string) (*bchain.BlockInfo, error) {
...
func (b *MateableRPC) GetBlockWithoutHeader(hash string, height uint32) (*bchain.Block, error) {
	data, err := b.GetBlockBytes(hash)
	if err != nil {
		return nil, err
	}
...
func (b *MateableRPC) GetBlockRaw(hash string) (string, error) {
...
func (b *MateableRPC) GetBlockBytes(hash string) ([]byte, error) {
...
func (b *MateableRPC) GetBlockFull(hash string) (*bchain.Block, error) {
...
func (b *MateableRPC) GetMempoolTransactions() ([]string, error) {
...
func (b *MateableRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
...
func (b *MateableRPC) GetTransaction(txid string) (*bchain.Tx, error) {
...
func (b *MateableRPC) GetTransactionSpecific(tx *bchain.Tx) (json.RawMessage, error) {
...
func (b *MateableRPC) getRawTransaction(txid string) (json.RawMessage, error) {
...
func (b *MateableRPC) EstimateSmartFee(blocks int, conservative bool) (big.Int, error) {
...
func (b *MateableRPC) EstimateFee(blocks int) (big.Int, error) {
...
func (b *MateableRPC) SendRawTransaction(tx string) (string, error) {
...
func (b *MateableRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
...
func (b *MateableRPC) Call(req interface{}, res interface{}) error {
